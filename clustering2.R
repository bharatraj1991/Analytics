...
km1 = kmeans(marks, center=2)# creates two clusters based on distances.. default distance is eucladian distance.. 
km1
plot(marks,col=km1$cluster,cex=1.5)
points(km1$center,col=1:2,pch=8,cex=2)
km1$iter # Gives the no. of iterations done to arrive at tis cluster
km1$betweenss
km1$tot.withinss
km1$withinss
#iris dataset
