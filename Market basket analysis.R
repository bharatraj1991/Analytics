...
frequentItems = eclat (Groceries, parameter = list(supp = 0.01, minlen= 2, maxlen = 5)) # min support means 0.01*10000(no. of values)= 100 times one combination is frequently purchased
...
rules
inspect (rules[1:5]) # 52% of people who bought baking powder bought whole milk and no. of people who bought all three were 92
